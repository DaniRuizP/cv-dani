const translations = {
    ca: {
        ...
        tech_list: ["Gestió i configuració de xarxes", "Implementació de bases de dades", "Seguretat activa i pasiva", "Python, HTML i CSS, XML"],
        ...
        plan_step2_t: "Curs d'especialització",
        plan_step2_d: "Cursar un curs d'especialització de ciberseguretat a Montilivi, Girona.",
        plan_step3_t: "Certificacions",
        plan_step3_d: "Obtenir el B2 anglès.",
    ...
    es: {
        ...
        plan_step2_t: "Curso de especialización",
        plan_step2_d: "Realizar un curso de especialización en ciberseguridad en Montilivi, Girona.",
        plan_step3_t: "Certificaciones",
        plan_step3_d: "Obtener el nivel B2 de inglés.",
    ...
    en: {
        ...
        plan_step2_t: "Specialization Course",
        plan_step2_d: "Enroll in a Cybersecurity specialization course in Montilivi, Girona.",
        plan_step3_t: "Certifications",
        plan_step3_d: "Obtain the B2 English certificate.",
