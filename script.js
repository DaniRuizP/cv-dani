const translations = {
    ca: {
        ...
        tech_list: ["Gestió, configuració i seguretat de xarxes", "Implementació de bases de dades", "Seguretat activa i pasiva", "Python, HTML i CSS, XML", "Administració de Linux i Windows", "Gestió de versions", "Docker i orquestració", "Treballar amb entorns virtuals"],
        ...
        plan_step2_t: "Certificacions d'estiu",
        plan_step2_d: "Durant l'estiu, vull dedicar-me a realitzar petits cursos per obtenir més coneixement sobre diferents àmbits.",
        plan_step3_t: "Curs d'especialització",
        plan_step3_d: "Cursar un curs d'especialització de ciberseguretat a Montilivi, Girona, per començar a anar cap a la branca de ciberseguretat.",
        plan_step4_t: "Certificacions",
        plan_step4_d: "Obtenir el B2 anglès.",
    ...
    es: {
        ...
        tech_list: ["Gestión, configuración y seguridad de redes", "Implementación de bases de datos", "Seguridad activa y pasiva", "Python, HTML y CSS, XML", "Administración de Linux y Windows", "Gestión de versiones", "Docker y orquestación", "Trabajo con entornos virtuales"],
        ...
        plan_step2_t: "Certificaciones de verano",
        plan_step2_d: "Durante el verano, quiero dedicarme a realizar pequeños cursos para obtener más conocimientos sobre diferentes ámbitos del sector tecnológico.",
        plan_step3_t: "Curso de especialización",
        plan_step3_d: "Realizar un curso de especialización en ciberseguridad en Montilivi, Girona, para empezar mi trayectoria en la rama de la ciberseguridad.",
        plan_step4_t: "Certificaciones",
        plan_step4_d: "Obtener el nivel B2 de inglés.",
    ...
    en: {
        ...
        tech_list: ["Network management, configuration, and security", "Database implementation", "Active and passive security", "Python, HTML & CSS, XML", "Linux and Windows administration", "Version control", "Docker and orchestration", "Working with virtual environments"],
        ...
        plan_step2_t: "Summer Certifications",
        plan_step2_d: "During the summer, I plan to take several short courses to gain more knowledge in different areas of the tech sector.",
        plan_step3_t: "Specialization Course",
        plan_step3_d: "Enroll in a Cybersecurity specialization course in Montilivi, Girona, to begin my career path in the cybersecurity branch.",
        plan_step4_t: "Certifications",
        plan_step4_d: "Obtain the B2 English certificate.",
        contact_title: "Contact",
        contact_desc: "You can reach me via email or by my phone."
    }
};
